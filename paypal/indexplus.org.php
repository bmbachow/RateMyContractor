   ...
   <div class="row justify-content-center">
     ...
     <br>
        ...
        <div class="col-4">
          ...
          <br>
          <br>
          <div id= "col-5" class="card mb-1">
            <div id= "col-5" class="card-body justify-content-center">
            <h3>Welcome To The Team!</h3>
            <hr/>
            <div id="paypal" >
                <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                  <input type="hidden" name="cmd" value="_s-xclick">
                  <input type="hidden" name="hosted_button_id" value="89YSVEKD8SJRQ">
                  <table>
                  <tr><td><input type="hidden" name="on0" value=""></td></tr><tr><td><select name="os0">
                    <option value="Basic Plus">Basic Plus : $40.00 USD - monthly</option>
                    <option value="Professional">Professional : $300.00 USD - yearly</option>
                  </select> </td></tr>
                  </table>
                  <input type="hidden" name="currency_code" value="USD">
                  <input type="image" src="../resources/button_join-now.png" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">

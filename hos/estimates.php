...
<html>
	<head>
        ...
        <script type="text/javascript" src="../getquotes/formquotes.js"></script>
...
<br>
    ...
    <form id="user_form" name="user_form" action="quotes.php"  method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
	<label>Phone</label>
	<input type="text" class="form-control" id="newContractorPhoneInput" required name="phone" placeholder="Phone" value="<?php if(isset($leadData[0]['phone'])){echo $leadData[0]['phone'];}?>">
	</div>    
    <div class="form-group">
	<label>Zip</label>

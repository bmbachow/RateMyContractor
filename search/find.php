    ...
    <div class="container">
        <div class="row">
            ...
            <div id="mid" class="col-6 text-left">
                <a href="profileviewer.php?uID=<?=$row["uID"];?>"><?=$row["bname"];?></a><br>
                <div><?=$row["city"];?>, <?=$row["state"];?> <?=$row["zip"];?></div>
                <div><p>Description: <?=$row["bio"];?></p></div><br><br>
                <div>Categories: <?=$row["type"];?></div>
                <a href='../hos/reviews.php?uID=".$row["uID"]."' target='_blank'>Review This Contractor |</a><a href="../getquotes/getquotes.php"> Get A Quote</a>
            </div>
            <div id="right" class="col-3">
                ...
                <?php if ($row['claimed']==0){?>
                    ...
                    <a id="btn" class="btn btn-primary btn-sm btn-block" href="../biz/claimsignup.php?uID=<?=$row["uID"];?>">Claim Your Profile</a>
                <?php } ?>
            </div>
        </div>
    </div>

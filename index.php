  ...
  <header>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url('./resources/Local-Contractors-near-me.jpg')" Alt="Contractors Near Me">
          <div class="carousel-caption d-none d-md-block">
            <h2><strong> Choose Who You Want</strong></h2>
          </div>
        </div>
        <!-- Slide Two - Set the background image for this slide in the line below -->
        <div class="carousel-item" style="background-image: url('./resources/Hire-the-best-local-contractors.jpg')" Alt="Best Local Contractors">
          <div class="carousel-caption d-none d-md-block">
            <h2><strong>Hire The Best</strong></h2>
          </div>
        </div>
        <!-- Slide Three - Set the background image for this slide in the line below -->
        <div class="carousel-item" style="background-image: url('./resources/Contractors.jpg')" Alt="Hire Local Contractors">
          <div class="carousel-caption d-none d-md-block">
    ...
    <div class="row w-75 mx-auto">
      <div class="col-lg-4 mb-5">
        <div class="card h-100">
          ...
          <div >
            <img class="card-img-bottom" src="./resources/Local-Contractors.jpg" Alt="Contractor Reviews With Local Contractors">
          </div>
      ...
      <div class="col-lg-4 mb-5">
        <div class="card h-100">
          ...
          <div>
            <img class="card-img-bottom" src="./resources/Review-Contractor.png" Alt="Contractor Reviews">
          </div>
          <div class="card-footer">
      ...
      <div class="col-lg-4 mb-5">
        <div class="card h-100">
          ...
          <div>
            <img class="card-img-bottom" src="./resources/Rate-Contractors.jpg" Alt="Contractor Rate Website Join Now">
          </div>
          <div class="card-footer">
    ...
    <div class="row w-100 mx-auto">
      <div class="col">
        <div class="card" style="border: 0 !important; margin-left: -2rem !important; margin-right: -2rem !important;margin-bottom: -3rem !important;">
          <img class="card-img" style="height: 30rem; width: 100% !important;" src="./resources/Review-Contractors.jpg" Alt="Contractor Ratings and Review Website">
